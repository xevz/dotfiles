...
" http://iijo.org
"
" $Id: vimDebug.vim,v 1.1 2005/03/19 17:53:00 eric Exp eric $
"
...
com! -nargs=* DBGRprintExpression  call DBGRprintExpression(<f-args>)
com! -nargs=1 DBGRprintExpression2 call DBGRprintExpression(<args>)
...
function! DBGRstartVimDebuggerDaemon(...)
   ...
   if a:0 > 0
      ...
      " build command
      let l:i = 1
      let l:cmd = "vdd " . l:debugger . " " . l:fileName
      while l:i <= a:0
